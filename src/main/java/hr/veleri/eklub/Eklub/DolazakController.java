...
//todo kriva je cijela klasa
public class DolazakController extends HomePageController {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(utakmica != null)
                {
                    new AlertDialog.Builder(DolazakController.this)
                    ...
                    showError(getString(R.string.selectUser),DolazakController.this);
                }
            }
        });
